...
public class InputSurface {
	 ...
	 * recording.
	 * <p>
	 * Configures new context to share with the now-current context, so we can
	...
	public void eglSetup() {
		...
		if (!EGL14.eglChooseConfig(mEGLDisplay, attribList, 0, configs, 0,
			...
			throw new RuntimeException(
					"unable to find RGB888recordable ES2 EGL config");
		}
		...
		mEGLContext = EGL14.eglCreateContext(mEGLDisplay, configs[0],
				EGL14.eglGetCurrentContext(), attrib_list, 0);
