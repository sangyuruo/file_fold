...
public class DataSyncControl_ResponseUpdatePOIImage extends DataSyncControl_ResponseFileBase{
	...
	public DataSyncControl_ResponseUpdatePOIImage(int iRequestId) {
		super(iRequestId);
	}
