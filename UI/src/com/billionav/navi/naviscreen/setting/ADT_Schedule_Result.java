...
public class ADT_Schedule_Result extends ActivityBase implements MapScreen{
	
	private RelativeLayout showList;
	private RelativeLayout showListBg;
	...
	private void findViews() {
		...
		showListBg = (RelativeLayout) findViewById(R.id.show_list_background);
	...
	private void setListeners() {
		...
		showListBg.setVisibility(View.GONE);
	}
	...
	protected void OnResume() {
		...
		PointBean bean = (PointBean) getBundleNavi().get("SchedulePointBean");
		if(bean != null){
