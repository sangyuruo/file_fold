...
public class SysMsgControl_ResponseBase extends PASyncRequest {
	...
	private long m_lUserRequestID = -1;
	
	private int m_iRequestId = 0;
	private String m_StrPassParam01	= "";
	
	public SysMsgControl_ResponseBase(int iRequestId) {
	...
	public void onEndOfResponse(){
		SysMsgControl_ResponseFactory.Instance().RemoveUserRequest(m_lUserRequestID);
	}

	public int getSysMsgRequestId() {
		return m_iRequestId;
	}
