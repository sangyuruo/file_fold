...
public class UserControl_RequestMemberKickOffPerson extends UserControl_RequestSNSBase{
	String m_strCycleID = "";
	String m_strUser = "";
	
	public UserControl_RequestMemberKickOffPerson(int iRequestId) {
		super(iRequestId);
	}
	
	public boolean SendRequestKickOffPerson() {
