...
public class UserControl_ResponseDeleteUser extends UserControl_ResponseBase{
	private int m_iResultCode = UserControl_ResponseBase.UC_RESPONES_SRV_FAIL;
	
	
	public UserControl_ResponseDeleteUser(int iRequestId)
	{
		super(iRequestId);
	}
	...
	public void doResponse() {
		...
		cTrigger.m_iTriggerID = NSTriggerID.UIC_MN_TRG_UC_DELETE_USER ;
