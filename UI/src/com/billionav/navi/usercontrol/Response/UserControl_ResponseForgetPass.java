...
public class UserControl_ResponseForgetPass extends UserControl_ResponseBase {	
	...
	public UserControl_ResponseForgetPass(int iRequestId)
	{
		super(iRequestId);
	}
	...
	public void doResponse() {
		...
		cTrigger.m_iTriggerID = NSTriggerID.UIC_MN_TRG_UC_SET_NEW_PASSWORD  ;
