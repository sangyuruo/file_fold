...
public class UserControl_ResponseGetCode extends UserControl_ResponseBase {	
	...
	public UserControl_ResponseGetCode(int iRequestId)
	{
		super(iRequestId);
	}
	...
	public void doResponse() {
		...
		cTrigger.m_iTriggerID = NSTriggerID.UIC_MN_TRG_UC_GET_VERIFICATION_CODE  ;
