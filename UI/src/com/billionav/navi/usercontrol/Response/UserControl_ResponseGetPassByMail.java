...
public class UserControl_ResponseGetPassByMail extends UserControl_ResponseBase {	
	...
	public UserControl_ResponseGetPassByMail(int iRequestId) {
		super(iRequestId);
	...
	public void doResponse() {
		...
		cTrigger.m_iTriggerID = NSTriggerID.UIC_MN_TRG_UC_GET_PASS_BY_EMAIL;
