...
public class UserControl_ResponseGetPhoto extends UserControl_ResponseBase {
	...
	public UserControl_ResponseGetPhoto(int iRequestId) {
		super(iRequestId);
	...
	public void doResponse() {
		...
		cTrigger.m_iTriggerID = NSTriggerID.UIC_MN_TRG_UC_GET_USER_PHOTO;
