...
public class UserControl_ResponseInviteUserIntoCircle extends UserControl_ResponseBase{
	...
	public UserControl_ResponseInviteUserIntoCircle(int iRequestId)
	{
		super(iRequestId);
	}
	public void doResponse() {
		...
		cTrigger.m_iTriggerID = NSTriggerID.UIC_MN_TRG_UC_INVITE_UER_INTO_CIRCLE  ;
