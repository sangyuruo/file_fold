...
public class UserControl_ResponseRegByMail extends UserControl_ResponseBase {	
	...
	public UserControl_ResponseRegByMail(int iRequestId) {
		super(iRequestId);
	...
	public void doResponse() {
		...
		cTrigger.m_iTriggerID = NSTriggerID.UIC_MN_TRG_UC_REG_BY_EMAIL;
