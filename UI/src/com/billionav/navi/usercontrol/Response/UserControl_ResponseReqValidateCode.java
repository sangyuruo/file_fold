...
public class UserControl_ResponseReqValidateCode extends UserControl_ResponseBase {	
	...
	public UserControl_ResponseReqValidateCode(int iRequestId) {
		super(iRequestId);
	...
	public void doResponse() {
		...
		cTrigger.m_iTriggerID = NSTriggerID.UIC_MN_TRG_UC_REQ_VALIDATECODE;
