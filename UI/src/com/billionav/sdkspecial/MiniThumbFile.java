...
public class MiniThumbFile {
	...
	public Bitmap getThumbnail(ContentResolver cr, long origId, int kind, long thumbMagic, byte[] sMiniThumbData) {
	...
	public Bitmap getThumbBitmapForEdit(ContentResolver cr, long origId) {
		return Images.Thumbnails.getThumbnail(cr, origId, Thumbnails.MINI_KIND, null);
	}
}
